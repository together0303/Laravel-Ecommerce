...
class HomePageController extends Controller
{
    ...
    public function index(){
        ...
        return response()->json(['popularCategory' => $popularCategory, 'categories' => $categories, 'subCategories' => $subCategories, 'childCategories' => $childCategories, 'threeColumnCategory' => $threeColumnCategory], 200);
    }
